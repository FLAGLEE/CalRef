...
#define PROGNAME    "CalRef"			/* program name */
...
int main(int argc, char **argv)
{
	...
	//const char fpconf[] = "D:\\Document\\RTK\\CalRef\\CalRef\\data\\calref.conf";				//conf
	//loadopts(fpconf, sysopts);
	//getsysopts(&prcopt, &solopt, &filopt);														//read .conf to opt
	//infile[n++] = "D:\\Document\\RTK\\CalRef\\CalRef\\data\\A000123060.20o";					//obs
	//infile[n++] = "D:\\Document\\RTK\\CalRef\\CalRef\\data\\BRDC00WRD_S_20203060000_01D_MN.rnx";//nav

	solopt.trace = 1;
	//sprintf(filopt.trace, "D:\\Document\\RTK\\CalRef\\CalRef\\data\\%s.trace", PROGNAME);
	//prcopt.soltype = 0;				/* solution type (0:forward,1:backward,2:combined) */
	
	//outfile = "D:\\Document\\RTK\\CalRef\\CalRef\\data\\A000123060_ALL.pos";
